    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="form-config-option" class="form-inline">
                    <div class="form-group">
                        ...
                        <input type="text" style="width:100px" class="form-control" name="value_field" id="value_field" />
                    </div>
                    <div class="form-group">
                        <label>Text</label><br>
                        <input type="text"  style="width:100px" class="form-control" name="text_field" id="text_field" />
                    </div>
                    <div class="form-group">
                        <label>Posicion</label><br>
                        <input type="number"  style="width:50px" placeholder="1" class="form-control" name="posicion" id="posicion" />
                    </div>
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary js-btn-guardar-cambios">Guardar cambios</button>
            </div>
        </div>
    </div>
</div>